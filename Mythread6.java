...
class Marvellous
{
    public int Arr[];  //characaristics

    public Marvellous(int size)
    {
        Arr = new int[size];
    }
    public void Accept() //input ghenyasathi method.
    {
     ...
     public void Display() //Display sathi chi method.
    {
    ...
    synchronized public void DisplayEven() //Display even number sathi method.
    {
        for(int i = 0;i<this.Arr.length;i++)
        {
            if(this.Arr[i]%2==0)
